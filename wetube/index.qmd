...
image: assets/wetube-thumbnail.png
categories:
  - HCI
  - Web Development
  - Gesture Control
...
other-links:
  ...
  - text: GitHub Repository
    ...
    icon: github
  - text: Report/PDF
    href: assets/projektdokumentation-wetube.pdf
    icon: file-pdf
resources:
  - assets/wetube.zip
  - assets/projektdokumentation-wetube.pdf
---
![](assets/wetube-thumbnail.png){width=80%}
